...
@Component({
  selector: 'app-anthropometrics-measures-q',
  templateUrl: './anthropometrics-measures-q.component.html',
  styleUrls: ['./anthropometrics-measures-q.component.css']
})
export class AnthropometricsMeasuresQComponent implements OnInit {
