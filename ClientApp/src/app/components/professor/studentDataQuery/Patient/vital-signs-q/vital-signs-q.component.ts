...
@Component({
  selector: 'app-vital-signs-q',
  templateUrl: './vital-signs-q.component.html',
  styleUrls: ['./vital-signs-q.component.css']
})
export class VitalSignsQComponent implements OnInit {
