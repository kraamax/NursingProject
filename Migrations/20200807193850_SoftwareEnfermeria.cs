...
namespace ProyectoEnfermeria.Migrations
{
    public partial class SoftwareEnfermeria : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PatientsFollowUps",
                columns: table => new
                {
                    IdFollowUp = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Findings = table.Column<string>(nullable: true),
                    NursingDiagnosis = table.Column<string>(nullable: true),
                    NOC = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientsFollowUps", x => x.IdFollowUp);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdPhysicalExam = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PacienteId = table.Column<string>(nullable: true),
                    Head_Face = table.Column<string>(nullable: true),
                    Eyes = table.Column<string>(nullable: true),
                    Ears = table.Column<string>(nullable: true),
                    Thorax = table.Column<string>(nullable: true),
                    Nose = table.Column<string>(nullable: true),
                    Oropharynx = table.Column<string>(nullable: true),
                    ...
                    Extremities = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
